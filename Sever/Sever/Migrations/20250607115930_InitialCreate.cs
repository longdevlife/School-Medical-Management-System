        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EventTypeID = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    NurseID = table.Column<string>(type: "nvarchar(50)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Notes = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    CheckerID = table.Column<string>(type: "nvarchar(50)", nullable: false),
                    ParentID = table.Column<string>(type: "nvarchar(50)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StudentID = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    ParentID = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    NurseID = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Medicine_Users_UpdatedBy",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Notes = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    StudentID = table.Column<string>(type: "nvarchar(50)", nullable: false),
                    VaccinatorID = table.Column<string>(type: "nvarchar(50)", nullable: false),
                    VaccineID = table.Column<string>(type: "nvarchar(450)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SchoolID = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    MedicineID = table.Column<string>(type: "nvarchar(50)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    DoseID = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    MedicineID = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    MedicineName = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: false),
                    Dosage = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: false),
                    TimeToTake = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MedicineDose", x => x.DoseID);
                    table.ForeignKey(
                        name: "FK_MedicineDose_Medicine_MedicineID",
                        column: x => x.MedicineID,
                        principalTable: "Medicine",
                        principalColumn: "MedicineID",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { "R1", "Parent" });

            migrationBuilder.InsertData(
                table: "Users",
                columns: new[] { "UserID", "Email", "Name", "Password", "Phone", "RoleID", "UserName" },
                values: new object[] { "U001", "parent1@example.com", "Phụ huynh Nguyễn Văn B", "123456", "0123456789", "R1", "parent1" });

            migrationBuilder.InsertData(
                table: "StudentProfile",
                columns: new[] { "StudentID", "Birthday", "Ethnicity", "Location", "Nationality", "ParentID", "RelationName", "Sex", "StudentName" },
                values: new object[] { "S001", new DateTime(2015, 5, 10, 0, 0, 0, 0, DateTimeKind.Unspecified), "Kinh", "Hà Nội", "Việt Nam", "U001", "Con", "Nam", "Nguyễn Văn A" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MedicineDose_MedicineID",
                table: "MedicineDose",
                column: "MedicineID");
